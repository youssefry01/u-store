...
const AccountFeed = ({ user }) => {
  ...
  return (
    <div className="flex w-full bg-white dark:bg-gray-900 md:py-8">
        <div className="flex flex-col w-full mx-auto max-w-screen-lg px-4 2xl:px-0 ">

            <div className='flex flex-row justify-between'>
                <AccountNav />
                <button type="button" className="flex h-10 px-8 items-center rounded-lg text-sm font-medium text-white bg-primary-700 hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
            ...
            <div className="flex flex-col w-full mt-4">
                ...
                <div className="flex flex-row w-full justify-around items-center rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
